...
async function getData(){
    let response= await fetch('https://iotmakerserver.herokuapp.com/user/GUI/bathroom/getdata',{
        method: 'get',
        mode: 'cors',
        headers:{
...
async function postData(){
    let response = await fetch('https://iotmakerserver.herokuapp.com/user/GUI/bathroom/postdata',{
        method: 'post',
        mode: 'cors', 
        headers:{
            //'Accept': 'application/json, text/plain, */*',
