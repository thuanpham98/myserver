...
async function getData(){
    let response= await fetch('https://iotmakerserver.herokuapp.com/user/GUI/kitchen/getdata',{
        method: 'get',
        mode: 'cors',
        headers:{
...
async function postData(){
    let response = await fetch('https://iotmakerserver.herokuapp.com/user/GUI/kitchen/postdata',{
        method: 'post',
        mode: 'cors', 
        headers:{
            //'Accept': 'application/json, text/plain, */*',
